  ...
  public Module(ModuleIO io, int index) {
    ...
    switch (Robot.getRuntimeType()) {
      ...
      default:
        ...
        driveFeedforward = new SimpleMotorFeedforward(0, 0); // 0,0,0
        driveFeedback = new PIDController(0.04, 0.0, 0.0); // p=0.04
        turnFeedback = new PIDController(2.0, 0.001, 0.07); // 2.0, 0.001, 0.07
        break;
    }

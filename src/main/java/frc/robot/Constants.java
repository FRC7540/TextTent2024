...
public final class Constants {
  ...
  public static final class HID {
    ...
    public static final double thetaJoystickScalar = 0.5;
  }
  ...
  public static final class Drivebase {
    ...
    public static final double MAX_LINEAR_SPEED = Units.feetToMeters(40); // 20 was 3o could be 25
  ...
  public static final class Climber {
    public static final double EXTENSION_RADIANS = 500.0;
